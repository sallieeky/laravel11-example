<template>
    <div class="top-0 fixed z-50 w-full">
        <div class="bg-primary-surface mx-auto pl-2 pr-4">
            <div class="flex justify-between">
                ...
                <div class="flex shrink-0 align-middle items-center m-2 relative">
                    <div class="hidden md:block group relative" v-if="isEnableGlobalSearch">
                        ...
                        <div class="hidden peer-focus-within:block hover:block absolute top-13 right-0 z-10 mt-2 w-64 md:w-[26rem] max-h-[24rem] overflow-y-auto origin-top-right rounded-md bg-white border border-gray-400 focus:outline-none shadow-lg" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                    ...
                    <button class="group text-start">
                        ...
                        <div class="hidden group-focus:block group-hover:block absolute top-13 mr-2 right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white border border-gray-400 focus:outline-none shadow-lg" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
        ...
        <div class="h-3 bg-primary-surface">
            <div class="pl-0 flex-1 flex transition-[padding-left] duration-300 ease-in-out" :class="[
                ...
                <div class="px-6 w-full">
                    <div class="bg-white px-8 rounded-t-xl h-3 border border-gray-400 border-b-white">
                    </div>
                </div>
            </div>
        </div>
